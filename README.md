...
I am an **AI Engineer** passionate about building intelligent systems powered by
**Large Language Models and modern AI architectures.**

My work focuses on designing and deploying:

- 🧠 Generative AI applications
- 🤖 Agentic AI systems
- 🔎 Retrieval-Augmented Generation (RAG) pipelines
- 💾 Memory-enabled AI systems
- ⚡ Efficient LLM fine-tuning workflows


I enjoy transforming AI research ideas into reliable,
...
Developing reliable knowledge-grounded AI systems using:
...
Exploring efficient model adaptation through:
